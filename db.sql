...
CREATE TABLE CIUDADES (
    ...
    NOM_CIU VARCHAR(15) NOT NULL
);

INSERT INTO CIUDADES VALUES ('AMT','AMBATO');
INSERT INTO CIUDADES VALUES ('UIO','QUITO');
INSERT INTO CIUDADES VALUES ('CUE','CUENCA');
INSERT INTO CIUDADES VALUES ('GYE','GUAYAQUIL');
...
CREATE TABLE CLIENTES (
    ...
    CIU_CLI REFERENCES CIUDADES (COD_CIU),
    DIR_CLI VARCHAR(50) NOT NULL,
    COR_CLI VARCHAR(50) NOT NULL,
	TEL_CLI VARCHAR(10) NOT NULL
);

INSERT INTO CLIENTES VALUES ('1806542447','DANIELA','IPIALES','AMT','MIRAFLORES','daniela@gmail.com','0991722125');
INSERT INTO CLIENTES VALUES ('1804131100','PEDRO','JARAMILLO','AMT','IZAMBA','pedro@gmail.com','0974088594');
INSERT INTO CLIENTES VALUES ('1802477626','LUIS','CORDOVA','AMT','MIRAFLORES','luis@gmail.com','0987376042');


CREATE TABLE FARMACEUTICOS (
    CED_FAR VARCHAR(10) PRIMARY KEY,
...
INSERT INTO FARMACEUTICOS VALUES ('1904290847','MONSERRATH','SALAZAR','monse@outlook.com','0985655446',500);
INSERT INTO FARMACEUTICOS VALUES ('1906961085','BELEN','CAMACHO','belen@gmail.com','0985600389',700);


CREATE TABLE BODEGUEROS (
    CED_BOD VARCHAR(10) PRIMARY KEY,
...
INSERT INTO BODEGUEROS VALUES ('2005883368','MARCELA','VASQUEZ','marcela@outlook.com','0987341934',800);


CREATE TABLE PROVEEDORES (
    COD_PRO VARCHAR(5) PRIMARY KEY,
    NOM_PRO VARCHAR(50) NOT NULL,
    CIU_PRO REFERENCES CIUDADES (COD_CIU),
    DIR_PRO VARCHAR(50) NOT NULL,
    COR_PRO VARCHAR(50) NOT NULL,
    TEL_PRO VARCHAR(10) NOT NULL
);

INSERT INTO PROVEEDORES VALUES ('PRO01','CORPORACION APIX S.A','GYE','AV LAS AMERICAS 510','atencion@apix.com','0994019636');
INSERT INTO PROVEEDORES VALUES ('PRO02','TUCANHEALTH S.A','UIO','AV PORTUGAL','serviciocliente@gmail.com','0991421788');


CREATE TABLE MEDICAMENTOS(
    COD_MED VARCHAR(8) PRIMARY KEY,
...
INSERT INTO MEDICAMENTOS VALUES ('M00E0001','SOLUCION DE AGUA DE MAR','MARIMER','01/03/2025',100,'SPRAY',13.57,14.14,9,'PRO02');
INSERT INTO MEDICAMENTOS VALUES ('M00E0002','DESODORANTE ANT-MANCH-AMARI','DR DRY','27/12/2024',55,'ROLL ON',4.20,5.50,40,'PRO01');
