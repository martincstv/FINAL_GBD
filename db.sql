...
IS
BEGIN
INSERT INTO RESPALDO_VENTAS
SELECT * FROM VENTAS;
END;
.
/

CREATE OR REPLACE TRIGGER RESPALDO_VENTAS_UPD
...
IS
BEGIN
INSERT INTO RESPALDO_DETALLE_VENTA
SELECT * FROM DETALLE_VENTA;
END;
.
/

CREATE OR REPLACE TRIGGER RESPALDO_DETALLE_VENTA_UPD
...
IS
BEGIN
DELETE RESPALDO_DETALLE_PEDIDO;
END;
.
/
...
IS
BEGIN
INSERT INTO RESPALDO_DETALLE_PEDIDO
SELECT * FROM DETALLE_PEDIDO;
END;
.
/

CREATE OR REPLACE TRIGGER RESPALDO_DETALLE_PEDIDO_UPD
...
BEGIN
    IF INSERTING THEN
        ...
        VALUES (USER,SYSDATE,'INSERTO',NULL,:NEW.COD_MED,NULL,:NEW.NOM_MED,NULL,:NEW.MAR_MED,NULL,:NEW.FEC_EXP_MED,NULL,:NEW.MLG_MED,NULL,:NEW.PRES_MED,NULL,:NEW.PRE_COM_MED,NULL,:NEW.PRE_VEN_MED,NULL,:NEW.EXI_MED,NULL,:NEW.COD_PRO);
    ELSE IF DELETING THEN
        INSERT INTO AUDITORIA_COM_MEDICAMENTOS (USUARIO,FECHA,ACCION,COD_MED_OLD,COD_MED_NEW,NOM_MED_OLD,NOM_MED_NEW,MAR_MED_OLD,MAR_MED_NEW,FEC_EXP_MED_OLD,FEC_EXP_MED_NEW,MLG_MED_OLD,MLG_MED_NEW,PRES_MED_OLD,PRES_MED_NEW,PRE_COM_MED_OLD,PRE_COM_MED_NEW,PRE_VEN_MED_OLD,PRE_VEN_MED_NEW,EXI_MED_OLD,EXI_MED_NEW,COD_PRO_OLD,COD_PRO_NEW)
        VALUES (USER,SYSDATE,'BORRO',:OLD.COD_MED,NULL,:OLD.NOM_MED,NULL,:OLD.MAR_MED,NULL,:OLD.FEC_EXP_MED,NULL,:OLD.MLG_MED,NULL,:OLD.PRES_MED,NULL,:OLD.PRE_COM_MED,NULL,:OLD.PRE_VEN_MED,NULL,:OLD.EXI_MED,NULL,:OLD.COD_PRO,NULL);
    ELSE IF UPDATING THEN
        INSERT INTO AUDITORIA_COM_MEDICAMENTOS (USUARIO,FECHA,ACCION,COD_MED_OLD,COD_MED_NEW,NOM_MED_OLD,NOM_MED_NEW,MAR_MED_OLD,MAR_MED_NEW,FEC_EXP_MED_OLD,FEC_EXP_MED_NEW,MLG_MED_OLD,MLG_MED_NEW,PRES_MED_OLD,PRES_MED_NEW,PRE_COM_MED_OLD,PRE_COM_MED_NEW,PRE_VEN_MED_OLD,PRE_VEN_MED_NEW,EXI_MED_OLD,EXI_MED_NEW,COD_PRO_OLD,COD_PRO_NEW)
        VALUES (USER,SYSDATE,'ACTUALIZO',:OLD.COD_MED,:NEW.COD_MED,:OLD.NOM_MED,:NEW.NOM_MED,:OLD.MAR_MED,:NEW.MAR_MED,:OLD.FEC_EXP_MED,:NEW.FEC_EXP_MED,:OLD.MLG_MED,:NEW.MLG_MED,:OLD.PRES_MED,:NEW.PRES_MED,:OLD.PRE_COM_MED,:NEW.PRE_COM_MED,:OLD.PRE_VEN_MED,:NEW.PRE_VEN_MED,:OLD.EXI_MED,:NEW.EXI_MED,:OLD.COD_PRO,:NEW.COD_PRO);
    END IF;
    END IF;
    END IF;
END;
